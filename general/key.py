...
cipher = binascii.unhexlify("0e0b213f26041e480b26217f27342e175d0e070a3c5b103e2526217f27342e175d0e077e263451150104")
plain = "crypto{1"
key = ""
flag = ""

for i in range(len(plain)):
	key += (chr(cipher[i] ^ ord(plain[i%len(plain)])))

for a in range(len(cipher)):
	flag += chr(cipher[a] ^ ord(key[a%len(key)]))
	print(flag)
